...
PATH_CKPT = f'/mnt/mydata/whlee/myckpts/unet_2023_dadain/my-unet-seed-{RANDOM_SEED}'
...
with open('./pkls/val_acc_list'+PATH_MARK+'_'+CLF_NAME, 'wb') as f:
